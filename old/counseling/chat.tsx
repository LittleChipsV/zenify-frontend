...
const ChatScreen = () => {
      ...
      <View style={[styles.messageBubble, item.sender === "user" ? styles.userBubble : styles.doctorBubble]}>
        ...
        {item.audio && (
          <TouchableOpacity onPress={() => playAudio(item.audio!)}>
            <Ionicons name="play-circle" size={40} color="#149FFF" />
          </TouchableOpacity>
        )}
      </View>
    </View>
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList data={messages} renderItem={renderMessage} keyExtractor={(item) => item.id} contentContainerStyle={styles.chatContainer} />
      ...
      <View style={styles.inputContainer}>
        ...
        <View style={styles.inputWrapper}>
          <TextInput style={styles.input} placeholder="Tulis pesan..." value={inputText} onChangeText={setInputText} />
        </View>
...
const styles = StyleSheet.create({
  ...
  iconButton: { width: 40, height: 40, justifyContent: "center", alignItems: "center", borderRadius: 20, backgroundColor: "#F6F6F6", marginRight: 8 },
